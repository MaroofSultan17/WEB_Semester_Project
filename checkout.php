...
<head>
    <title> Checkout | <?php echo (constant('siteTitle')); ?>
    </title>
                    ...
                    <div class="checkout-left">
                        ...
                        <div class="checkout-form">
                            ...
                            <div class="checkbox-form">
                                ...
                                <textarea class="check-message" id="message" name="message" placeholder="Order Note"
                                    required></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="checkout-review-order">
                            ...
                            <div class="ev-order-review">
                                ...
                                <div class="ev-shop-table">
                                    ...
                                    <div class="cart-item">
                                        <ul
                                            class="product-name-price d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="checkout-payment">
                                        <form class="checkout-radio">
                                            <ul class="radio-items">
                                                <li class="radio-item">
                                                    <span>
                                                        <input type="radio" id="flexRadioDefault1" name="radio-group"
                                                            checked>
                                                        <label for="flexRadioDefault1">Terms and Conditions:</label>
                                                    </span>
                                                    <div class="radio-text">
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
                                                            do eiusmod tempor incidid gna aliqua.</p>
                                                    </div>
                                                </li>
                                                <li class="radio-item">
                                                    <span>
