                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label class="select2-label" for="id_label_multiple">
                                    ...
                                    <select class="select2-with-label-multiple js-states" style="width:100%;"
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <select class="multi-select-placeholder js-states" style="width:100%;"
                                    multiple="multiple">
                                    <option value="Alaska">Alaska</option>
                                    <option value="Hawaii">Hawaii</option>
                                    <option value="California">California</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <p>Select2 will work on RTL websites if the <code>dir</code> attribute is set on the
                                        <code>&lt;select&gt;</code><span class="copy-to-clipboard"
                                            title="Copy to clipboard"></span> or any parents of it. You can also
                                        initialize Select2 with the <code>dir: "rtl"</code><span
                                            class="copy-to-clipboard" title="Copy to clipboard"></span> configuration
                                        option.
                                    </p>
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button class="js-programmatic-set-val btn btn-primary mb-2"
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mt-4">
                                    <select class="js-example-programmatic-multi" style="width:100%;"
                                        multiple="multiple">
                                        <option value="AL">Alaska</option>
                                        <option value="HA">Hawaii</option>
                                        <option value="CA">California</option>
