							...
							<div class="cm-content-body form excerpt">
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-bordered table-striped table-condensed flip-content ">
											...
											<tbody>
												<tr>
													...
													<td><a onclick="myFunction(this)"
															class=" btn btn-primary btn-sm content-icon status m-0"><i
												...
												<tr>
													...
													<td><a href="javascript:void(0);"
															class=" btn btn-primary btn-sm content-icon m-0"><i
																class="fa-solid fa-check"></i></a></td>
													<td>04 Feb, 2024</td>
													<td class="text-end">
														<a href="javascript:void(0);"
										...
										<div
											class="d-flex align-items-center justify-content-sm-between justify-content-center flex-wrap">
											<small>Page 1 of 4, showing 2 records out of 8 total, starting on record 1,
												ending on 2</small>
