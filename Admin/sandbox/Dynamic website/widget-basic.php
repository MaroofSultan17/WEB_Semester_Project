											...
											<div class="timeline-panel">
												...
												<div class="media-body">
													...
													<a href="javascript:void(0);"
														class="btn btn-primary btn-xxs shadow">Reply</a>
													<a href="javascript:void(0);"
														class="btn btn-outline-danger btn-xxs">Delete</a>
												</div>
												<div class="dropdown">
													<button type="button" class="btn btn-primary light sharp"
														data-bs-toggle="dropdown">
								...
								<div class="card-action mb-sm-0 my-2">
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										<li class="nav-item" role="presentation">
											<a class="nav-link active" id="home-tab" href="javascript:void(0);"
												data-bs-toggle="tab" data-bs-target="#home-tab-pane" role="tab"
												aria-selected="true">Day</a>
										</li>
										<li class="nav-item" role="presentation">
											<a class="nav-link" id="profile-tab" href="javascript:void(0);"
												data-bs-toggle="tab" data-bs-target="#profile-tab-pane" role="tab"
												aria-selected="false">Month</a>
										</li>
										<li class="nav-item" role="presentation">
											<a class="nav-link" id="contact-tab" href="javascript:void(0);"
						...
						<div class="card active_users">
							...
							<div class="card-body pt-0">
								<div class="list-group-flush mt-4">
									<div
										class="list-group-item bg-transparent d-flex justify-content-between border-0 border-bottom px-0 py-1 font-weight-semi-bold">
										<p class="mb-0">Top Active Pages</p>
										<p class="mb-0">Active Users</p>
									</div>
									<div
										class="list-group-item bg-transparent d-flex justify-content-between border-0 border-bottom px-0 py-2">
									...
									<div
										class="list-group-item bg-transparent d-xxl-flex justify-content-between px-0 py-2 d-none">
										<p class="mb-0">/</p>
										<p class="mb-0">2</p>
									</div>
									<div
					...
					<div class="col-xl-4 col-lg-12 col-sm-12">
						<div class="card overflow-hidden">
							...
							<ul class="list-group list-group-flush">
								...
								<li class="list-group-item d-flex justify-content-between"><span class="mb-0">Patient
										Height</span> <strong class="text-muted">1.5 M </strong></li>
							</ul>
