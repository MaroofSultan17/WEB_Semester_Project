								...
								<div class="row justify-content-between">
									...
									<div class="col-xl-4 col-xxl-6">
										...
										<div class="card-content">
											<p class="text-justify">Ambitioni dedisse scripsisse iudicaretur. Cras
												...
												totius Galliae in diem certam indicere. Cras mattis iudicium purus sit
												amet fermentum.</p>
										</div>
									</div>
									<div class="col-xl-4 col-xxl-12">
										<div class="mb-4">
											...
											<p>Use tags <code>text-start, text-center, text-end</code> for get desire
												text.</p>
										</div>
										<div class="card-content">
									...
									<div class="col-lg-6">
										<div class="mb-4">
											...
											<p>Use tags
												...
												for get desire text.</p>
										</div>
										<div class="card-content">
											<p class="text-sm-start">Left aligned text on viewports sized SM (small) or
												wider.</p>
											<p class="text-md-start">Left aligned text on viewports sized MD (medium) or
												wider.</p>
											<p class="text-lg-start">Left aligned text on viewports sized LG (large) or
												wider.</p>
											<p class="text-xl-start">Left aligned text on viewports sized XL
									...
									<div class="col-lg-6">
										<div class="mb-4">
											...
											<p>Use tags <code>fw-bold, fw-normal, fst-italic</code> for get desire text.
											</p>
										</div>
										<div class="card-content">
									...
									<div class="col-lg-4">
										...
										<div class="card-content">
											<p class="text-muted">This is an example of muted text. Add
												class<code>text-muted</code></p>
											...
											<p class="text-info">This is an example of info text. Add
												class<code>text-info</code></p>
									...
									<div class="col-lg-4 mb-3">
										...
										<ul class="list-icons">
											<li><span class="align-middle me-2"><i class="ti-angle-right"></i></span>
									...
									<div class="col-lg-4 mb-3">
										...
										<ul class="list-icons">
											<li><a href="javascript:void(0)"><span class="align-middle me-2"><i
															class="fa fa-check text-info"></i></span> Lorem ipsum dolor
													sit amet</a></li>
											<li><a href="javascript:void(0)"><span class="align-middle me-2"><i
															class="fa fa-check text-info"></i></span>Consectetur
													adipiscing elit</a></li>
											<li><a href="javascript:void(0)"><span class="align-middle me-2"><i
															class="fa fa-check text-info"></i></span>Integer molestie
													lorem at massa</a></li>
										</ul>
									</div>
									<div class="col-lg-4 mb-3">
										...
										<ul class="list-icons">
											<li><a href="javascript:void(0)"><span class="align-middle me-2"><i
															class="fa fa-chevron-right"></i></span> Lorem ipsum dolor
													sit amet</a></li>
											<li><a href="javascript:void(0)"><span class="align-middle me-2"><i
															class="fa fa-chevron-right"></i></span>Consectetur
													adipiscing elit</a></li>
											<li><a href="javascript:void(0)"><span class="align-middle me-2"><i
															class="fa fa-chevron-right"></i></span>Integer molestie
													lorem at massa</a></li>
										</ul>
									</div>
								</div>
