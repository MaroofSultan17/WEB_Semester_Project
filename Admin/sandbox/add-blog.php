					...
					<div class="col-xl-12">
						<div class="mb-5">
							<ul class="d-flex align-items-center flex-wrap">
								...
								<li><a href="blog-category.php" class="btn btn-primary me-1 mt-sm-0 mt-1">Add Blog Category</a></li>
							...
							<div class="col-xl-8">
								...
								<div class="filter cm-content-box box-primary">
									<div class="content-title">
										...
										<div class="tools"><a href="javascript:void(0);" class="expand SlideToolHeader"><i class="fa fa-angle-down"></i></a>
										</div>
									</div>
									<div class="cm-content-body form excerpt">
										<div class="card-body">
