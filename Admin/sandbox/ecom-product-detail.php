                                        ...
                                        <div class="tab-slide-content new-arrival-product mb-4 mb-xl-0">
											...
											<ul class="nav nav-tabs slide-item-list mt-3" id="myTab" role="tablist">
											  <li class="nav-item" role="presentation">
												<a href="#first" class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"  role="tab" aria-controls="home-tab-pane" aria-selected="true"><img class="img-fluid me-2 rounded" src="images/tab/1.jpg" alt="/" width="50"></a>
											  </li>
											  <li class="nav-item" role="presentation">
												<a href="#second" class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane"  role="tab" aria-controls="profile-tab-pane" aria-selected="false"><img class="img-fluid me-2 rounded" src="images/tab/2.jpg" alt="/" width="50"></a>
											  </li>
											  <li class="nav-item" role="presentation">
												<a href="#third" class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" role="tab" aria-controls="contact-tab-pane" aria-selected="false"><img class="img-fluid me-2 rounded" src="images/tab/3.jpg" alt="/" width="50"></a>
											  </li>
											  <li class="nav-item" role="presentation">
												<a href="#for" class="nav-link" id="end-tab" data-bs-toggle="tab" data-bs-target="#end-tab-pane"  role="tab" aria-controls="end-tab-pane" aria-selected="false"><img class="img-fluid rounded" src="images/tab/4.jpg" alt="/" width="50"></a>
											  </li>
													...
													<div class="filtaring-area mb-3 me-3">
														<div class="size-filter">
															...
															<div class="btn-group mb-sm-0 mb-2" role="group" aria-label="Basic radio toggle button group">
															  <input type="radio" class="form-check-input btn-check" name="btnradio" id="btnradio1" checked="">
															  <label class="form-check-label btn btn-outline-primary mb-0" for="btnradio1">XS</label>

															  <input type="radio" class="form-check-input btn-check" name="btnradio" id="btnradio2">
															  <label class="form-check-label btn btn-outline-primary mb-0" for="btnradio2">SM</label>

															  <input type="radio" class="form-check-input btn-check" name="btnradio" id="btnradio3">
															  <label class="form-check-label btn btn-outline-primary mb-0" for="btnradio3">MD</label>
															  
															  <input type="radio" class="form-check-input btn-check" name="btnradio" id="btnradio4">
															  <label class="form-check-label btn btn-outline-primary mb-0" for="btnradio4">LG</label>
															  
															  <input type="radio" class="form-check-input btn-check" name="btnradio" id="btnradio5">
															  <label class="form-check-label btn btn-outline-primary mb-0" for="btnradio5">XL</label>
															</div>
														</div>
													</div>
													<!--Quantity start-->
