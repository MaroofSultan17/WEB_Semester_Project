											...
											<table class="table items-table">
												...
												<tbody>
													<tr>
														<td>
															<div class="media">
																<a href="ecom-product-detail.php"><img class="me-3 img-fluid rounded" src="images/card/Untitled-6.jpg" alt="DexignZone"></a>
																<div class="media-body">
																	<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
																	<h5 class="mt-0 mb-2 mb-sm-3"><a class="text-black" href="ecom-product-detail.php">Chicken curry special with cucumber</a></h5>
													...
													<tr>
														<td>
															<div class="media">
																<a href="ecom-product-detail.php"><img class="me-3 img-fluid rounded" src="images/card/Untitled-4.jpg" alt="DexignZone"></a>
																<div class="media-body">
																	<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
																	<h5 class="mt-0 text-black  mb-2 mb-sm-3"><a class="text-black" href="ecom-product-detail.php">Watermelon juice with ice</a></h5>
																	<div class="star-review d-flex fs-14">
																		<i class="fa fa-star text-orange"></i>
																		<i class="fa fa-star text-orange"></i>
																		<i class="fa fa-star text-orange"></i>
													...
													<tr>
														<td>
															<div class="media">
																<a href="ecom-product-detail.php"><img class="me-3 img-fluid rounded" src="images/card/Untitled-5.jpg" alt="DexignZone"></a>
																<div class="media-body">
																	<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
																	<h5 class="mt-0 text-black  mb-2 mb-sm-3"><a class="text-black" href="ecom-product-detail.php">Italiano pizza with garlic</a></h5>
																	<div class="star-review d-flex fs-14">
																		<i class="fa fa-star text-orange"></i>
																		<i class="fa fa-star text-orange"></i>
																		<i class="fa fa-star text-orange"></i>
