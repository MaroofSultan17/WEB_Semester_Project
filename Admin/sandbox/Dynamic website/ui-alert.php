                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-xxl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary solid alert-square"><strong>Welcome!</strong> Message
                                    has been sent.</div>
                                <div class="alert alert-secondary solid alert-square"><strong>Done!</strong> Your
                                    profile photo updated.</div>
                                <div class="alert alert-success solid alert-square "><strong>Success!</strong> Message
                                    has been sent.</div>
                                <div class="alert alert-info solid alert-square "><strong>Info!</strong> You have got 5
                                    new email.</div>
                                <div class="alert alert-warning solid alert-square "><strong>Warning!</strong> Something
                                    went wrong. Please check.</div>
                                <div class="alert alert-danger solid alert-square "><strong>Error!</strong> Message
                                    sending failed.</div>
                    ...
                    <div class="col-xl-6 col-xxl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary solid alert-rounded"><strong>Welcome!</strong> Message
                                    has been sent.</div>
                                <div class="alert alert-secondary solid alert-rounded"><strong>Done!</strong> Your
                                    profile photo updated.</div>
                                <div class="alert alert-success solid alert-rounded "><strong>Success!</strong> Message
                                    has been sent.</div>
                                <div class="alert alert-info solid alert-rounded "><strong>Info!</strong> You have got 5
                                    new email.</div>
                                <div class="alert alert-warning solid alert-rounded "><strong>Warning!</strong>
                                    Something went wrong. Please check.</div>
                                <div class="alert alert-danger solid alert-rounded "><strong>Error!</strong> Message
                                    sending failed.</div>
                    ...
                    <div class="col-xl-6 col-xxl-12">
                        <div class="card">
                            <div class="card-header d-block">
                                ...
                                <p class="mb-0 subtitle">add <code>.alert-alt.solid</code> class to change the solid
                                    color.
                                </p>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary alert-dismissible fade show">
                                    ...
                                    <strong>WOW! Eveything looks OK.</strong> <a href="javascript:void(0);">Please check
                                        this one as
                                        well</a>
                                </div>
                                ...
                                <div class="alert alert-info alert-dismissible fade show">
                                    ...
                                    <strong>Hey! Take a quick look.</strong> <a href="javascript:void(0);">My birthday
                                        party</a>
                                </div>
                                <div class="alert alert-warning alert-dismissible fade show">
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    ...
                                    <strong>Warning!</strong> Why you did it to me! <a href="javascript:void(0);">Check
                                        this out</a>
                                </div>
                                <div class="alert alert-danger alert-dismissible fade show">
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    ...
                                    <strong>Error!</strong> Something Went wrong <a href="javascript:void(0);">Click
                                        here for details.</a>
                                </div>
                                <div class="alert alert-dark alert-dismissible fade show">
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary solid alert-dismissible fade show">
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                                        aria-label="btn-close">
                                    </button> WOW! Eveything looks OK. <a href="javascript:void(0);"
                                ...
                                <div class="alert alert-info solid alert-dismissible fade show">
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                                        aria-label="btn-close">
                                    </button> Hey! Take a quick look. <a href="javascript:void(0);"
                                ...
                                <div class="alert alert-warning solid alert-dismissible fade show">
                                    ...
                                    <strong>Warning!</strong> Why you did it to me! <a href="javascript:void(0);"
                                ...
                                <div class="alert alert-danger solid alert-dismissible fade show">
                                    ...
                                    <strong>Error!</strong> Something Went wrong <a href="javascript:void(0);"
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="alert alert-primary notification">
                                            <p class="notificaiton-title mb-2"><strong>Success!</strong> Vampires The
                                                Romantic Ideology Behind Them</p>
                                            <p>The following article covers a topic that has recently moved to center
                                                stage-at lease it seems that way.</p>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="alert alert-danger notification">
                                            <p class="notificaiton-title mb-2"><strong>Danger! </strong> Religion And
                                                Science
                                            </p>
                                            <p>What is the loop of Creation? How is there something from nothing? In
                                                spite of the fact.. </p>
                    ...
                    <div class="col-xl-6 col-xxl-12">
                        <div class="card">
                            <div class="card-header d-block">
                                ...
                                <p class="mb-0 subtitle">add <code>.alert-outline-primary,secondary,success...</code> to
                                    change the style</p>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="alert alert-social facebook alert-dismissible fade show">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="mb-0 opacity-75 fs-14">Cras sit amet nibh libero, in
                                                        gravida nulla. tempus viverra turpis. Fusce condimentum nunc ac
                                        ...
                                        <div class="alert alert-primary alert-dismissible fade show">
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    ...
                                                    <p class="mb-0">Cras sit amet nibh libero, in gravida nulla. tempus
                                        ...
                                        <div class="alert alert-primary left-icon-big alert-dismissible fade show">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="mb-0">Please confirm your email address: email@example.com
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
