...
<head>
    <title> Shopping Cart | <?php echo (constant('siteTitle')); ?>
    </title>
    ...
    <section class="wishlist-section shopping-section">
        <div class="container">
            <div class="wishlist-item">
                        ...
                        <tbody class="t-body">
                            <tr class="wishlist-tr">
                                <td class="d-lg-flex d-lg-block align-items-center">
                                    ...
                                    <h2><a href="single-product.php">Tritan steel water bottle</a></h2>
                                </td>
                                ...
                                <td>
                                    <div class="pro-counter d-flex align-items-center justify-content-between">
                                        ...
                                        <input type="number" class="counter-input" id="quantity1" value="0" min="0"
                                            readonly>
                            ...
                            <tr class="wishlist-tr">
                                <td class="d-lg-flex d-lg-block align-items-center">
                                    ...
                                    <h2><a href="single-product.php">Ray Ban fashion sunglass</a></h2>
                                </td>
                                <td><span>$93.00</span></td>
                                <td>
                                    <div class="pro-counter d-flex align-items-center justify-content-between">
                                        <button onclick="decrement('quantity2')" class="counter-button">-</button>
                                        <input type="number" class="counter-input" id="quantity2" value="0" min="0"
                                            readonly>
                            ...
                            <tr class="wishlist-tr">
                                <td class="d-lg-flex d-lg-block align-items-center">
                                    ...
                                    <h2><a href="single-product.php">Mens fashion running shoes</a></h2>
                                </td>
                                <td><span>$48.00</span></td>
                                <td>
                                    <div class="pro-counter d-flex align-items-center justify-content-between">
                                        <button onclick="decrement('quantity3')" class="counter-button">-</button>
                                        <input type="number" class="counter-input" id="quantity3" value="0" min="0"
                                            readonly>
                ...
                <div
                    class="shoping-cart-btn d-md-flex d-md-block align-items-center justify-content-md-between justify-content-md-start">
                            ...
                            <div class="chectout-cart">
                                <ul class="sub-total">
                                    <li class="d-flex align-items-center justify-content-between">
                                        <h6>Sub Total</h6> <span>$183.00</span>
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
                                        <h6>Shipping </h6> <span>$10.00</span>
                                    </li>
                                </ul>
                                <ul class="grand-total">
                                    <li class="d-flex align-items-center justify-content-between">
                                        <h6>Grand Total</h6><span>$193.00</span>
                                    </li>
                                </ul>
                                <div class="checkout-text">
