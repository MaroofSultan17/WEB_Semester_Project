									...
									<table class="table table-sm mb-0">
										...
										<tbody id="orders">
											...
											<tr class="btn-reveal-trigger">
												...
												<td class="py-2 text-end"><span
														class="badge badge-sm badge-primary">Processing<span
											...
											<tr class="btn-reveal-trigger">
												...
												<td class="py-2 text-end"><span
														class="badge badge-sm badge-secondary">On
											...
											<tr class="btn-reveal-trigger">
												...
												<td class="py-2">
													<a href="javascript:void(0);">
														<strong class="text-primary">#185</strong></a> by <strong
														class="text-primary">Rocky
														Zampa</strong><br><a
											...
											<tr class="btn-reveal-trigger">
												...
												<td class="py-2">
													<a href="javascript:void(0);">
														<strong class="text-primary">#186</strong></a> by <strong
														class="text-primary">Ricky John</strong><br><a
														href="mailto:ricky@example.com">ricky@example.com</a>
												</td>
												<td class="py-2">30/04/2020</td>
											...
											<tr class="btn-reveal-trigger">
												...
												<td class="py-2">
													<a href="javascript:void(0);">
														<strong class="text-primary">#187</strong></a> by <strong
														class="text-primary">Cristofer
														Henric</strong><br><a
											...
											<tr class="btn-reveal-trigger">
												...
												<td class="py-2">
													<a href="javascript:void(0);">
														<strong class="text-primary">#188</strong></a> by <strong
														class="text-primary">Brate Lee</strong><br><a
											...
											<tr class="btn-reveal-trigger">
												...
												<td class="py-2">
													<a href="javascript:void(0);">
														<strong class="text-primary">#189</strong></a> by <strong
														class="text-primary">Thomas
											...
											<tr class="btn-reveal-trigger">
												...
												<td class="py-2">
													<a href="javascript:void(0);">
														<strong class="text-primary">#190</strong></a> by <strong
														class="text-primary">Evie Singh</strong><br><a
											...
											<tr class="btn-reveal-trigger">
												...
												<td class="py-2">
													<a href="javascript:void(0);">
														<strong class="text-primary">#191</strong></a> by <strong
														class="text-primary">David
														Peters</strong><br><a
											...
											<tr class="btn-reveal-trigger">
												...
												<td class="py-2">
													<a href="javascript:void(0);">
														<strong class="text-primary">#192</strong></a> by <strong
														class="text-primary">Jennifer
														Johnson</strong><br><a
