...
<head>
    <title> Single Blog | <?php echo (constant('siteTitle')); ?>
    </title>
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-12 col-12">
                    <div class="ev-blog-items single-blog-items">
                        <div class="blog-inner">
                            <div class="blog-img">
                                <a href="single-blog.php">
                                    <img src="images/single-blog/details/shape-1.png" alt="blog">
                                </a>
                            </div>
                            <div class="blog-text">
                                ...
                                <h2><a href="single-blog.php"> How to buy a T-shirt for a friend</a></h2>
                                <p>Kimod tempoer incididunt onomes sundo ritoma amar Lorem ipsum dolor sit amet, consec
                                    tetur adipi sicing elit, sed do eiusmod tempor inci didunt ut labore et
                                    dolore magna aliqu magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                                    ullamco laboris </p>
                                <p>Minisi ut aliquip ex ea commodo conseq Lorem ipsum dolor sit amet, consectetur
                                    adipisic ing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                                    aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                                    aliquip ex ea commodo con sequat. Duis aute irure dolor
                                    in reprehenderit in voluptate velit esse cillum dol</p>
                                <ul class="d-flex quote-text">
                                    <li><img src="images/single-blog/quot/shape-1.png" alt="quot"> </li>
                                    <li>
                                        <p>sint occaecat cupidatat non proident, sunt in culpa qui officia
                                            deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste
                                            natus error sit voluptatem accusantium </p>
                                    </li>
                                </ul>
                                <p>et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem
                                    quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores
                                    eos qui rati one voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem
                                    ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius
                                    modi tempora incidunt ut labore etlorem
                                    ipsum quia dolor sit a dolore magnam aliquam quaerat voluptatem.</p>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                                    exercitation ulla mco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                                    irure dolor in reprehender it in voluptate velit esse cillum dolore eu fugiat nulla
                                ...
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    ...
                                    ab illo inventore veritatis et quasi archi tecto beatae vitae dicta sunt explicabo.
                                </p>
                                <div
                                    class="social-items single-blog-tags d-lg-flex d-lg-block align-items-center justify-content-between">
                                ...
                                <ul class="product-details d-flex align-items-center justify-content-between">
                                    <li><a href="#" class="preview-text">Jokod tempor incididunt ut labore et dolore
                                            magna aliqua.</a></li>
                                    <li><a href="#" class="preview-text">Jokod tempor incididunt ut labore et dolore
                                            magna aliqua.</a></li>
                                </ul>
                                <div class="blog-author-bio d-lg-flex d-md-blog">
                                    <div class="author-img">
                                        <img src="images/single-blog/author/shape-1.png" alt="author">
                                    </div>
                                    <div class="authoi-info">
                                        ...
                                        <p class="preview-text">Nemo enim ipsam voluptatem quia voluptas sit aspernatur
                                            aut odit consequuntur magni dolores eos qui ratione voluptatem
                                    ...
                                    <div class="comment-wrapper">
                                        <div class="comment-inner  d-lg-flex d-md-block">
                                            <div class="comment-img">
                                                <img src="images/single-blog/comment/shape-1.png" alt="comment">
                                            </div>
                                            <div class="comment-text">
                                                ...
                                                <p class="preview-text">Lnseq uuntur magni dolores eos qui ratione
                                                    voluptatem sequi nesciu nt. uis quam est, qui dolorem Lorem ipsum
                                                    dolor sit amet,
                                                    consectetur adipisicing elit, sed do ecididunt ut labore et dolore
                                                    magna aliqua.</p>
                                            </div>
                                        </div>
                                        <div class="comment-inner  d-lg-flex d-md-block">
                                            <div class="comment-img">
                                                <img src="images/single-blog/comment/shape-2.png" alt="comment">
                                            </div>
                                            <div class="comment-text">
                                                <ul class="comment-top d-flex justify-content-between">
                                                    <li>
                                        ...
                                        <div class="comment-inner d-lg-flex d-md-block">
                                            <div class="comment-img">
                                                <img src="images/single-blog/comment/shape-3.png" alt="comment">
                                            </div>
                                            <div class="comment-text">
                                                <ul class="comment-top d-flex justify-content-between">
                                                    <li>
                                        ...
                                        <div class="comment-inner d-lg-flex d-md-block">
                                            <div class="comment-img">
                                                <img src="images/single-blog/comment/shape-4.png" alt="comment">
                                            </div>
                                            <div class="comment-text">
                                                <ul class="comment-top d-flex justify-content-between">
                                                    <li>
                        ...
                        <form class="contuct-form" action="https://ethemestudio.com/demo/evani/process_form.php"
                            method="post">
                            <div class="form-text">
                                <h4>Add A Comment</h4>
                            ...
                            <textarea class="input-textarea" name="message" rows="5" cols="30" placeholder="Your name *"
                                required></textarea>
                    ...
                    <div class="ev-side-bar">
                        ...
                        <div class="preo-shop common-blog-item">
                            <div class="preo-shop-img">
                                <img src="images/single-blog/more/shape-1.png" alt="blog">
                            </div>
                            <div class="preo-shop-inner">
                                <div class="shop-inner-info">
                                    <span>Preo Shop</span>
                                    <h4>Guide to buy best thing</h4>
                                    <p>Kimod tempoer incididunt onomes sundo ritoma amar consectetur adipi sicing elit
                                    </p>
                        ...
                        <div class="bar-recent-post common-blog-item">
                            ...
                            <div class="recent-post d-flex align-items-center">
                                <div class="post-img">
                                    <a href="single-blog.php">
                                        <img src="images/single-blog/sidebar-post/shape-1.png" alt="post">
                                    </a>
                                </div>
                                <div class="blog-text">
                                    <span>April 15, 2021</span>
                                    <h2><a href="single-blog.php">Dalia enim ad minim olok veniam quis</a></h2>
                                </div>
                            </div>
                            <div class="recent-post d-flex align-items-center">
                                <div class="post-img">
                                    <a href="single-blog.php">
                                        <img src="images/single-blog/sidebar-post/shape-2.png" alt="post">
                                    </a>
                                </div>
                                <div class="blog-text">
                                    <span>April 15, 2021</span>
                            ...
                            <div class="recent-post d-flex align-items-center">
                                <div class="post-img">
                                    <a href="single-blog.php">
                                        <img src="images/single-blog/sidebar-post/shape-3.png" alt="post">
                                    </a>
                                </div>
                                <div class="blog-text">
                                    <span>April 15, 2021</span>
                        ...
                        <div class="bar-catagories common-blog-item">
                            ...
                            <ul>
                                ...
                                <li><a href="#"><i class="fa-solid fa-caret-right"></i> Search Engine Optimization</a>
                                </li>
                        ...
                        <div class="bar-gallery common-blog-item">
                            ...
                            <ul class="gallery-items">
                                <li><a href="#"><img src="images/single-blog/tag/shape-1.png" alt="gallery"></a></li>
                                <li><a href="#"><img src="images/single-blog/tag/shape-2.png" alt="gallery"></a></li>
                                <li><a href="#"><img src="images/single-blog/tag/shape-3.png" alt="gallery"></a></li>
                                <li><a href="#"><img src="images/single-blog/tag/shape-4.png" alt="gallery"></a></li>
                                <li><a href="#"><img src="images/single-blog/tag/shape-5.png" alt="gallery"></a></li>
                                <li><a href="#"><img src="images/single-blog/tag/shape-6.png" alt="gallery"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
