								...
								<div class="card">
									<div class="card-body">
										<div class="profile-blog">
											...
											<h4><a href="post-details.php" class="text-black">Darwin's Special Pizza Place</a></h4>
									...
									<div class="card-body">
										<div class="profile-news">
											...
											<div class="media pt-3 pb-3">
												...
												<div class="media-body">
													<h5 class="m-b-5"><a href="post-details.php" class="text-black">Collection's of Tasty Pizza</a></h5>
											...
											<div class="media pt-3 pb-3">
												...
												<div class="media-body">
													<h5 class="m-b-5"><a href="post-details.php" class="text-black">List Out Your Best Pizza</a></h5>
													<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
												</div>
											</div>
											<div class="media pt-3 pb-3">
												...
												<div class="media-body">
													<h5 class="m-b-5"><a href="post-details.php" class="text-black">Find out the Best Taste</a></h5>
													<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
												</div>
											</div>
										</div>
                                            ...
                                            <div id="my-posts" class="tab-pane fade active show">
                                                <div class="my-post-content pt-3">
															...
															<div class="modal-dialog modal-dialog-centered" role="document">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		...
																		<a class="btn-social linkedin" href="javascript:void(0)" ><i class="fa-brands fa-linkedin-in"></i></a>
														...
														<div class="modal fade" id="postModal">
															<div class="modal-dialog modal-dialog-centered" role="document">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		 <textarea name="textarea" cols="30" rows="5" class="form-control bg-transparent" placeholder="Please type what you want...."></textarea>
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
														...
														<a class="post-title" href="post-details.php"><h3 class="text-black">Taste Is Main Priority Here</h3></a>
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
														...
														<a class="post-title" href="post-details.php"><h3 class="text-black">Double Cheese Dacker Special Pizza </h3></a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                            of spare which enjoy whole heart.</p>
                                                        <button class="btn btn-primary me-2"><span class="me-2"><i class="fa fa-heart"></i></span>Like</button>
                                                        <button class="btn btn-secondary"  data-bs-toggle="modal" data-bs-target="#replyModal"><span class="me-2"><i class="fa fa-reply"></i></span>Reply</button>
                                                    ...
                                                    <div class="profile-uoloaded-post pb-3">
                                                        <img src="images/profile/8.jpg" alt="/" class="img-fluid w-100">
														<a class="post-title" href="post-details.php"><h3 class="text-black">Are You Looking For,the best Pizza Place?</h3></a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                            of spare which enjoy whole heart.</p>
                                                        <button class="btn btn-primary me-2"><span class="me-2"><i class="fa fa-heart"></i></span>Like</button>
                                                        <button class="btn btn-secondary"  data-bs-toggle="modal" data-bs-target="#replyModal"><span class="me-2"><i class="fa fa-reply"></i></span>Reply</button>
                                                        ...
                                                        <form>
                                                            ...
                                                            <div class="mb-3">
                                                               <div class="form-check custom-checkbox">
																	<input type="checkbox" class="form-check-input mt-0" id="gridCheck">
